...
2. Clone _your_ repo to your local development machine. *Cloning the OG repo will prevent you from submitting pull requests
```
...
## [Serving the Website](https://cli.vuejs.org/guide/cli-service.html#using-the-binary)
